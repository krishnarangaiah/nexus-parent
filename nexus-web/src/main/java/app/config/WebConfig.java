...
public class WebConfig implements WebServerFactoryCustomizer<ConfigurableServletWebServerFactory>, WebMvcConfigurer {
    ...
    public void customize(ConfigurableServletWebServerFactory factory) {
        LOGGER.info("WebConfig ServeletFactory is: {}", factory);
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // Disable caching for static resources (JS, CSS, etc.)
    ...
    public ClassLoaderTemplateResolver templateResolver() {
        ...
        templateResolver.setCacheable(false);  // Disable template caching
